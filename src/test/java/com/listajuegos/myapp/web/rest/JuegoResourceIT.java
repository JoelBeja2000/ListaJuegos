...
import static com.listajuegos.myapp.web.rest.TestUtil.createFormattingConversionService;
...
public class JuegoResourceIT {
    ...
    public void setup() {
        ...
        final JuegoResource juegoResource = new JuegoResource(juegoService);
